...
//        String projectPath = System.getProperty("user.dir")+"/wms001";
...
////        pc.setModuleName(scanner("模块名字"));
//        pc.setParent("com.example.wms001")
//                .setEntity("entity").setMapper("mapper").setService("service")
